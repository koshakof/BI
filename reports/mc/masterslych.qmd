...
```{r temp9, include = FALSE, eval = FALSE}

# временный код для сокращения времени рендера
vroom::vroom_write(x      = segments_raw, 
                   file   = "~/GitHub/BI/data/mc_segments_raw.txt", 
                   delim  = ",",
                   append = FALSE)
...
# загрузка данных
segments_raw <- vroom::vroom(file = "~/GitHub/BI/data/mc_segments_raw.txt")
