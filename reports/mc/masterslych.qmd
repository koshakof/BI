...
camp_30 %>% 
  kbl(format = "html",
      caption = "Таблица: Сводка по РК за последние 30 дней", 
      escape = F) %>% 
  kable_paper() %>% 
  kable_styling(bootstrap_options = c("hover", "condensed", "responsive"),
                full_width = F) %>% 
  row_spec(0, 
           ...
           color = "#5A5A5A",
           align = "r") %>%
  row_spec(1:length(camp_30$Campaign),
           align = "r") %>%
  column_spec(c(1,4),
              border_right = T)
...
groups_30 %>% 
  kbl(format = "html",
      caption = "Метрики по группам за последние 30 дней и затратами больше 0",
      escape = F) %>% 
  kable_paper() %>% 
  kable_styling(bootstrap_options = c("hover", 
                                      "condensed", 
  ...
  row_spec(0, 
           ...
           color = "#5A5A5A",
           font_size = 16) %>% 
  row_spec(1:length(groups_30$Campaign),
           align = "r",
           font_size = 14) %>%
  column_spec(c(2, 5),
              border_right = T) %>% 
...
groups_7 %>% 
  kbl(format = "html",
      caption = "Метрики по группам за последние 7 дней и затратами больше 0",
      escape = F) %>% 
  kable_paper() %>% 
  kable_styling(bootstrap_options = c("hover", 
                                      "condensed", 
  ...
  row_spec(0, 
           ...
           color = "#5A5A5A",
           font_size = 16) %>% 
  row_spec(1:length(groups_7$Campaign),
           align = "r",
           font_size = 14) %>%
  column_spec(c(2, 5),
              border_right = T) %>% 
